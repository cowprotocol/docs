...
* Token conservation per order: This is a very technical constraint that was part of CIP-11. More information about it can be found [here](token-conservation-per-order-aka-local-token-conservation.md).
