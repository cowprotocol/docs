...
CoW Protocol is a meta-DEX aggregation protocol that leverages [trade intents](/cow-protocol/concepts/introduction/intents) and [batch auctions](/cow-protocol/concepts/introduction/batch-auctions) to find users better prices for trading tokenized assets.
...
- Private Market Makers (e.g. Wintermute, Hashflow, etc.)
