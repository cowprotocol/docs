...
- **[Using Existing Wrappers](#for-order-creators--frontend-developers)** - Add wrappers to your orders and integrate into your application
...
# For Order Creators / Frontend Developers
...
Wrappers are specified in the order's [`appData`](TODO) under the `wrappers` field:
...
All approved wrappers will be approved by the DAO and registered in [`GPv2AllowlistAuthenticator`](../references/contracts/core/allowlist.md). It is recommended to verify wrappers are allowlisted before including them in settlements.
...
- **[Contracts Reference](../reference/contracts/periphery/wrapper.md)** - Contract specifications
