...
If you're using the CoW Protocol's provided driver, wrappers are handled automatically. Just ensure your solver process includes wrapper information in the solution output.
...
Account for wrapper gas overhead in your bids. The easiest way to do this is to simulate the wrapper transaction against an empty settlement.
