...
Initial notes: The proposed transactions and interactions, can be executed through Safe's transaction builder, etherscan "Write Contract" or from other UI mechanisms or directly from console.
