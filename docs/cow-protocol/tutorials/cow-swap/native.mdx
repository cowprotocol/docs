...
Once you have confirmed the swap, your wallet will prompt you to the on-chain transaction interacting with [Eth-flow](/cow-protocol/reference/contracts/periphery/eth-flow). On completion of this transaction, your order will be placed on CoW Protocol:

![Eth-flow Transaction](/img/cowswap/native_tx.png)

:::note

When using [Eth-flow](/cow-protocol/reference/contracts/periphery/eth-flow), your order is only placed once the transaction that sends your ETH into the Eth-flow contract is confirmed.
