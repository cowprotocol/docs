...
|Off-chain|On-chain|
|-|-|
| <Image img={require('/img/cowswap/swap_off-chain-cancellation.png')} alt="Modal for off-chain cancellation" /> | <Image img={require('/img/cowswap/swap_on-chain-cancellation.png')} alt="Modal for on-chain cancellation" /> |
