...
Go to [CoW Swap](https://swap.cow.finance/#/swap?utm_source=docs.cow.finance&utm_content=swap-tutorial) and connect your web3 wallet.
...
CoW Swap has a special integration with [Safe](https://app.safe.global) when opened as a [Safe app](https://app.safe.global/share/safe-app?appUrl=https%3A%2F%2Fswap.cow.finance&chain=eth), where the approval and order placement transactions can be combined into a single Safe transaction.
