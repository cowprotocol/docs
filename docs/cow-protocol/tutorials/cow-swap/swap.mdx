...
This is because this contract needs to pull the `WETH` from our wallet and send it to the [_settlement_](/cow-protocol/reference/contracts/core/settlement) contract that will co-ordinate the swap on your behalf.
...
By default, CoW Swap prompts you to give the [vault relayer](/cow-protocol/reference/contracts/core/vault-relayer) contract an "unlimited" allowance for the sell token.
