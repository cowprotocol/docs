...
<Image
  img={require("/img/cowswap/swap_gas-free_approval.png")}
  alt="Token selector showing a list of tokens matching the filter 'DAI', where some have the tag 'Gas-free approval'"
/>
