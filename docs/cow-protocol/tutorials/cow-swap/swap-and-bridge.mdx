...
5. Your Swap & Bridge order history is available in the **Account modal** on CoW Swap. It displays only last 10 orders, you can find the whole orders history in [CoW Explorer](https://explorer.cow.fi).
