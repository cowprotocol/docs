...
Currently, the Swap & Bridge functionality is limited to swap orders and is not available for smart contract wallets. Support for these features is currently under development.
...
* There is a list of Account Proxy versions, in the most cases you need to use the **latest** one unless told otherwise.
