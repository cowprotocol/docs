...
- Multisigs such as [Safe](https://safe.global), both as a [Safe app](https://app.safe.global/share/safe-app?appUrl=https%3A%2F%2Fswap.cow.fi&chain=eth), or using Wallet Connect (IOS/Android).
- [WalletConnect v2](https://walletconnect.com): Any wallet supporting Wallet Connect such us most mobile app wallets.
- [Trezor](https://trezor.io), [Ledger](https://www.ledger.com): Directly or through injected wallets like Rabby or Metamask.
