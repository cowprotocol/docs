...
You can use it in the Görli and Sepolia test nets if you want. Otherwise, it is available in Mainnet and Gnosis Chain.

💡 If you need Sepolia Ether, you can use this [PoW-based Faucet](https://sepolia-faucet.pk910.de/). You can also ask us!
...
The API is available in the following different Networks: Mainnet, Gnosis Chain, and the Görli and Sepolia testnets.
