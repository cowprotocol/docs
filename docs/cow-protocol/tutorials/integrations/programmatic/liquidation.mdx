...
<details open>
  ...
  Any book-keeping to account or split the extra proceeds can happen in pre- and post-interactions (aka <a href="/cow-protocol/reference/core/intents/hooks">hooks</a>). 
