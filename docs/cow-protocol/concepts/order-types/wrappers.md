...
- **For technical specs**: Consult the [Technical Reference](../../reference/contracts/periphery/wrapper.md) for detailed contract documentation and API specifications
