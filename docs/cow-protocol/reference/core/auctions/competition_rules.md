...
- Solver submitting a transaction needs to be whitelisted (the process on how a solver can get whitelisted is described [here](/cow-protocol/reference/core/auctions/bonding-pools))
