...
Cancelling an intent off-chain removes your order from the offchain orderbook and will no longer broadcasted it to solvers starting as of the next auction.
