...
- Create a new topic in the [Governance category](https://forum.cow.finance/c/cow-improvement-proposals-cip/6/none), using the [proposal template pinned](https://forum.cow.finance/t/cip-0-template/28) to the top of the _Governance Resources_ category.
