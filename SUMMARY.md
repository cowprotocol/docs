...
* [CoW Hooks](overview/cow-hooks/README.md)
  * [CoW Hooks Example](overview/cow-hooks/cow-hooks-example/README.md)
    * [Requirements](overview/cow-hooks/cow-hooks-example/requirements.md)
...
* [Introduction](solvers/solvers.md)
* [In-depth: The Solver Competition](solvers/in-depth-solver-specification/README.md)
  * [Introduction](solvers/in-depth-solver-specification/introduction.md)
  * [The Batch Auction Optimization Problem](solvers/in-depth-solver-specification/the-batch-auction-optimization-problem.md)
  * [Social Consensus Rules](solvers/in-depth-solver-specification/social-consensus-rules.md)
  * [Solver Auction and Rewards](solvers/in-depth-solver-specification/solver-auction-and-rewards.md)
  * [Slippage accounting](solvers/in-depth-solver-specification/slippage-accounting.md)
  * [Input: Batch auction instances](solvers/in-depth-solver-specification/input-batch-auction-instances.md)
  * [Output: Batch auction solutions](solvers/in-depth-solver-specification/output-batch-auction-solutions.md)
  * [Getting notified about the ranking](solvers/in-depth-solver-specification/getting-notified-about-the-ranking.md)
  * [Sample Test Instances](solvers/in-depth-solver-specification/sample-test-instances.md)
* [How to Build a Solver](solvers/how-to-build-a-solver/README.md)
  * [Solver Workshop](solvers/how-to-build-a-solver/solver-workshop.md)
...
* [Creating App Ids](front-end/creating-app-ids/README.md)
  ...
  * [Create the order meta-data file](front-end/creating-app-ids/create-the-order-meta-data-file/README.md)
    ...
    * [Additional Order Preferences](front-end/creating-app-ids/create-the-order-meta-data-file/additional-order-preferences.md)
