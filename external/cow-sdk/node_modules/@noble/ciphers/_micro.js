 ...
 */
exports.xsalsa20poly1305 = (0, utils_js_1.wrapCipher)({ blockSize: 64, nonceLength: 24, tagLength: 16 }, function xsalsapoly(key, nonce) {
    return {
        encrypt(plaintext) {
...
const _poly1305_aead = (fn) => (key, nonce, AAD) => {
    ...
    return {
        encrypt(plaintext) {
            ...
            return (0, utils_js_1.concatBytes)(data, tag);
        },
        decrypt(ciphertext) {
