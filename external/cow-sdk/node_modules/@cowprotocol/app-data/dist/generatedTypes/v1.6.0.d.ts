...
/**
 * The Ethereum address of the flashloan lender
 */
export type LenderAddress = string;
/**
 * The Ethereum address of the flashloan borrower
 */
export type BorrowerAddress = string;
/**
