...
exports.Api = exports.GetQuoteErrorType = exports.QuotePriceQuality = exports.apiUrl = exports.LIMIT_CONCURRENT_REQUESTS = exports.Environment = void 0;
...
exports.LIMIT_CONCURRENT_REQUESTS = 5;
...
var QuotePriceQuality;
(function (QuotePriceQuality) {
    QuotePriceQuality["FAST"] = "fast";
    QuotePriceQuality["OPTIMAL"] = "optimal";
})(QuotePriceQuality = exports.QuotePriceQuality || (exports.QuotePriceQuality = {}));
...
function estimateTradeAmount(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var side, quote, estimatedAmount;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    side = kind == order_1.OrderKind.SELL
                        ? {
                    ...
                    return [4 /*yield*/, getQuote({ baseUrl: baseUrl }, __assign({ from: ethers_1.constants.AddressZero, sellToken: sellToken, buyToken: buyToken, priceQuality: QuotePriceQuality.FAST }, side))];
                case 1:
                    quote = (_b.sent()).quote;
                    ...
                    if (quote.buyToken.toLowerCase() !== buyToken.toLowerCase()) {
                        throw new Error("Price returned for sell token ".concat(sellToken, " uses an incorrect quote token (").concat(quote.buyToken.toLowerCase(), " instead of ").concat(buyToken.toLowerCase(), ")"));
                    }
                    estimatedAmount = kind == order_1.OrderKind.SELL ? quote.buyAmount : quote.sellAmount;
                    return [2 /*return*/, ethers_1.BigNumber.from(estimatedAmount)];
            }
        });
    });
}
function placeOrder(_a) {
    var order = _a.order, signature = _a.signature, baseUrl = _a.baseUrl, from = _a.from;
    return __awaiter(this, void 0, void 0, function () {
        var normalizedOrder;
        return __generator(this, function (_b) {
            switch (_b.label) {
