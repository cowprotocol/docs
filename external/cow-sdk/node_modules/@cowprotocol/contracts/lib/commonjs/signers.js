...
exports.IntChainIdTypedDataV4Signer = exports.TypedDataV3Signer = exports.TypedDataVersionedSigner = void 0;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        address = _a.sent();
                        // Actual signing
                        return [2 /*return*/, this.provider.send(this._signMethod, [address.toLowerCase(), msg])];
                }
            });
        });
    };
 ...
 * All other Signer methods are proxied to initial instance.
 */
var TypedDataV3Signer = /** @class */ (function (_super) {
    __extends(TypedDataV3Signer, _super);
    function TypedDataV3Signer(signer) {
        return _super.call(this, signer, "v3") || this;
    }
