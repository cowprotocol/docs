...
exports.decodeEip1271SignatureData = exports.encodeEip1271SignatureData = exports.signOrderCancellations = exports.signOrderCancellation = exports.signOrder = exports.SigningScheme = exports.PRE_SIGNED = exports.EIP1271_MAGICVALUE = void 0;
...
function signOrderCancellation(domain, orderUid, owner, scheme) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, signOrderCancellations(domain, [orderUid], owner, scheme)];
        });
    });
}
 ...
 * @return Encoded signature including signing scheme for the cancellation.
 */
function signOrderCancellations(domain, orderUids, owner, scheme) {
    return __awaiter(this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ecdsaSignTypedData(scheme, owner, domain, { OrderCancellations: order_1.CANCELLATIONS_TYPE_FIELDS }, { orderUids: orderUids })];
                case 1: return [2 /*return*/, (_a.data = _b.sent(),
                        _a)];
            }
        });
...
exports.signOrderCancellations = signOrderCancellations;
/**
