 ...
 * @return Encoded signature including signing scheme for the cancellation.
 */
export declare function signOrderCancellations(domain: TypedDataDomain, orderUids: BytesLike[], owner: Signer, scheme: EcdsaSigningScheme): Promise<EcdsaSignature>;
/**
