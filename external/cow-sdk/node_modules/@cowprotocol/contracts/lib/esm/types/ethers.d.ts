 ...
 */
export type TypedDataDomain = Parameters<typeof ethers.utils._TypedDataEncoder.hashDomain>[0];
/**
 * EIP-712 typed data type definitions.
 */
export type TypedDataTypes = Parameters<typeof ethers.utils._TypedDataEncoder.hashStruct>[1];
/**
